...
public class MyPApplet extends PApplet{
	...
	public void setup() {
		...
		img = loadImage("palmTrees.jpg", "jpg"); // here we display the image into memory
	}
	
	public void draw() {
		//Add drawing code for MyPApplet
		img.resize(0, height);			//resize loaded image to full height of canvas , height is instance variable for PApplet class 
